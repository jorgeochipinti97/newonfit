  ...
  return (
    ...
    >
      ...
      >
        <div class="icons">
          <a
            href="https://www.instagram.com/tiendaonfitarg/"
          ...
          <a href="mailto:tienda@onfit.com.ar" class="icon linkedin">
            <svg
              fill="#ffffff"
              height="48"
              width="48"
          ...
          <a href="https://www.tiktok.com/@tiendaonfit" class="icon tiktok ">
            <svg
              fill="#ffffff"
              height="48"
              width="48"
